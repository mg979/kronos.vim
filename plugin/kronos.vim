...
command! -nargs=* -complete=custom,<sid>kronos_cmd_complete Kronos call kronos#EntryPoint(<q-args>)
command! -nargs=* -complete=custom,<sid>kronos_cmd_complete K      call kronos#EntryPoint(<q-args>)
